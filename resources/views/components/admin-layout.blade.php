...
<div>
                        ...
                        <li class="">
                            ...
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                <li>
                                  ...
                                  class="{{RouteManager::isCurrentPage(Session::get('current_route_name'),['equipment.index'],'active-link','inactive-link')}}">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
    ...
    <div class="lg:pl-72">
        ...
        <div class="p-16 ">
          <div class="px-16  text-4xl font-semibold text-gray-700 rubik-400 mb-8">
            @yield('title')
        </div>
            {{$slot}}
