           ...
           <nav class="flex flex-1 flex-col mt-8 ">
             <ul role="list" class="flex flex-1 flex-col gap-y-7 ">
                 <li>
                         ...
                         {{-- <div class="text-sm font-semibold leading-6 text-gray-400"></div> --}}
                          ...
                          <ul role="list" class="-mx-2 mt-2 space-y-1">
                              <li class=" mb-6">
                                  ...
                                  class="{{RouteManager::isCurrentPage(Session::get('current_route_name'),['admins.index','admins.create','admins.edit'],'active-link','inactive-link') }}">
                                    <div class="flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                                          <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                                        </svg>
                                    </div>
                                    <span class="ml-2 truncate">Manage Administrators</span>
                                  </a>
                              </li>
                          </ul>
                          @endcan
                    ...
                    <div class="mt-6">
                        <li class="">
                            <div class="text-sm font-semibold leading-6 text-sksu-800">MANAGEMENT </div>
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                <li>
                                  <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                                  <a href="{{route('users.index')}}"
                                  class=" {{RouteManager::isCurrentPage(Session::get('current_route_name'),['users.index'],'active-link','inactive-link') }}">
                                   ...
                                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                                    ...
                                    <span class="ml-2 truncate">Users</span>
                                  </a>
                                </li>
                                <li>
                                  <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                                ...
                                {{-- <li>
                                  ...
                                  class="{{RouteManager::isCurrentPage(Session::get('current_route_name'),['reports.index'],'active-link','inactive-link') }}">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                              ...
                              <li>
                                ...
                                <li>
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                                    ...
                                    <span class="ml-2 truncate">My Equipment Requests</span>
                                     @livewire('total-pending-request')
                                  </a>
                                </li>
                                <li>
                                  <a href="{{route('joborders.index')}}"
                                  class="{{RouteManager::isCurrentPage(Session::get('current_route_name'),['joborders.index','joborders.create','joborders.edit','joborders.view'],'active-link','inactive-link') }}">
