<div>
    ...
    <div class="flex">
        <div class="flex mr-2">
            <img src="{{ asset('images/headerlogo1.png') }}" class="w-16 mx-auto  h-16" alt="University Logo">
        ...
        <div>
            ...
            <p class="leading-[1.1rem] text-lg text-[#008000] font-semibold uppercase">SULTAN KUDARAT STATE UNIVERSITY</p>
            <p class="leading-[1.1rem] text-gray-600 text-sm">Isulan Campus, Isulan, Sultan Kudarat 9805</p>
