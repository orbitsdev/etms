<div>
    ...
    <p>Unavailable Items Count: {{ $record->countUnavailableItems() }}</p>
</div>
              ...
              <div class="py-3 xl:pb-0 xl:pt-6">
                ...
                <div class="text-base/7 text-gray-700">
                  ...
                  <ul role="list" class="mt-5 list-disc space-y-2 pl-6 marker:text-gray-300">
                    <li class="pl-3">Tempor ultrices proin nunc fames nunc ut auctor vitae sed. Eget massa parturient vulputate fermentum id facilisis nam pharetra. Aliquet leo tellus.</li>
                    <li class="pl-3">Turpis ac nunc adipiscing adipiscing metus tincidunt senectus tellus.</li>
                    <li class="pl-3">Semper interdum porta sit tincidunt. Dui suspendisse scelerisque amet metus eget sed. Ut tellus in sed dignissim.</li>
                  </ul>
                </div>
              </div>
            </div>
